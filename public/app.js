...
const ATTRIBUTE_DATA = {
  ...
  lasting: { label: "Lasting", summary: "Efecto duradero: el objeto o beneficio permanece activo mas alla del uso inmediato. La duracion exacta depende de la carta." },
